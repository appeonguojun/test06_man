$PBExportHeader$w_pbr2_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_pbr2_frame from window
end type
type mdi_1 from mdiclient within w_pbr2_frame
end type
end forward
...
global w_pbr2_frame w_pbr2_frame

type variables
n_pbr2_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_pbr2_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_pbr2_sheet1", "w_pbr2_sheet2", "w_pbr2_sheet3" }
...
inv_sheetmgt = Create n_pbr2_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_pbr2_frame.create
if this.MenuName = "m_pbr2_frame" then this.MenuID = create m_pbr2_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_pbr2_frame.destroy
